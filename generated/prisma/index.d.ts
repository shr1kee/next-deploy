...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> = {
    ...
    meta: {
      modelProps: "user" | "account" | "session" | "verificationToken" | "actor" | "film" | "filmActor"
   ...
   * FilmCountOutputType without action
   */
  export type FilmCountOutputTypeCountActorsArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    where?: FilmActorWhereInput
  }
  ...
  export type ActorOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "category" | "year" | "createdAt" | "updatedAt", ExtArgs["result"]["actor"]>
  ...
  export type $ActorPayload<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    name: "Actor"
    objects: {
      films: Prisma.$FilmActorPayload<ExtArgs>[]
    }
    scalars: $Extensions.GetPayloadResult<{
      id: string
      name: string
  ...
  export interface Prisma__ActorClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: "PrismaPromise"
    films<T extends Actor$filmsArgs<ExtArgs> = {}>(args?: Subset<T, Actor$filmsArgs<ExtArgs>>): Prisma.PrismaPromise<$Result.GetResult<Prisma.$FilmActorPayload<ExtArgs>, T, "findMany", GlobalOmitOptions> | Null>
    /**
     * Attaches callbacks for the resolution and/or rejection of the Promise.
     * @param onfulfilled The callback to execute when the Promise is resolved.
     * @param onrejected The callback to execute when the Promise is rejected.
  ...
  interface ActorFieldRefs {
    ...
    readonly category: FieldRef<"Actor", 'Category'>
    readonly year: FieldRef<"Actor", 'Float'>
  ...
  export type FilmSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetSelect<{
    ...
    name?: boolean
    imageUrl?: boolean
    actors?: boolean | Film$actorsArgs<ExtArgs>
  ...
  export type FilmOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "imageUrl", ExtArgs["result"]["film"]>
  ...
  export interface Prisma__FilmClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: "PrismaPromise"
    actors<T extends Film$actorsArgs<ExtArgs> = {}>(args?: Subset<T, Film$actorsArgs<ExtArgs>>): Prisma.PrismaPromise<$Result.GetResult<Prisma.$FilmActorPayload<ExtArgs>, T, "findMany", GlobalOmitOptions> | Null>
    /**
     * Attaches callbacks for the resolution and/or rejection of the Promise.
     * @param onfulfilled The callback to execute when the Promise is resolved.
     * @param onrejected The callback to execute when the Promise is rejected.
  ...
  interface FilmFieldRefs {
    ...
    readonly name: FieldRef<"Film", 'String'>
    readonly imageUrl: FieldRef<"Film", 'String'>
  }
   ...
   * Film.actors
   */
  export type Film$actorsArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * Select specific fields to fetch from the FilmActor
     */
    select?: FilmActorSelect<ExtArgs> | null
  ...
  export type FilmActorOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "filmId" | "actorId", ExtArgs["result"]["filmActor"]>
  ...
  export interface FilmActorDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * })
     * 
     * // Create many FilmActors and only return the `id`
     * const filmActorWithIdOnly = await prisma.filmActor.createManyAndReturn({
     *   select: { id: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * })
     * 
     * // Update zero or more FilmActors and only return the `id`
     * const filmActorWithIdOnly = await prisma.filmActor.updateManyAndReturn({
     *   select: { id: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  interface FilmActorFieldRefs {
    readonly id: FieldRef<"FilmActor", 'String'>
    readonly filmId: FieldRef<"FilmActor", 'String'>
    readonly actorId: FieldRef<"FilmActor", 'String'>
  }
  ...
  export type ActorWhereInput = {
    ...
    category?: EnumCategoryFilter<"Actor"> | $Enums.Category
    year?: FloatFilter<"Actor"> | number
    createdAt?: DateTimeFilter<"Actor"> | Date | string
    updatedAt?: DateTimeFilter<"Actor"> | Date | string
    films?: FilmActorListRelationFilter
  }
  ...
  export type ActorOrderByWithRelationInput = {
    ...
    createdAt?: SortOrder
    updatedAt?: SortOrder
    films?: FilmActorOrderByRelationAggregateInput
  }
  ...
  export type ActorScalarWhereWithAggregatesInput = {
    ...
    category?: EnumCategoryWithAggregatesFilter<"Actor"> | $Enums.Category
    year?: FloatWithAggregatesFilter<"Actor"> | number
  ...
  export type FilmWhereInput = {
    ...
    name?: StringFilter<"Film"> | string
    imageUrl?: StringNullableFilter<"Film"> | string | null
    actors?: FilmActorListRelationFilter
  }
  ...
  export type FilmOrderByWithRelationInput = {
    ...
    actors?: FilmActorOrderByRelationAggregateInput
  }
  ...
  export type FilmScalarWhereWithAggregatesInput = {
    ...
    name?: StringWithAggregatesFilter<"Film"> | string
    imageUrl?: StringNullableWithAggregatesFilter<"Film"> | string | null
  }
  ...
  export type FilmActorWhereInput = {
    ...
    id?: StringFilter<"FilmActor"> | string
    filmId?: StringFilter<"FilmActor"> | string
    actorId?: StringFilter<"FilmActor"> | string
  ...
  export type FilmActorScalarWhereWithAggregatesInput = {
    ...
    id?: StringWithAggregatesFilter<"FilmActor"> | string
    filmId?: StringWithAggregatesFilter<"FilmActor"> | string
    actorId?: StringWithAggregatesFilter<"FilmActor"> | string
  }
  ...
  export type ActorCreateInput = {
    ...
    createdAt?: Date | string
    updatedAt?: Date | string
    films?: FilmActorCreateNestedManyWithoutActorInput
  }
  ...
  export type ActorUncheckedCreateInput = {
    ...
    createdAt?: Date | string
    updatedAt?: Date | string
    films?: FilmActorUncheckedCreateNestedManyWithoutActorInput
  }
  ...
  export type ActorUpdateInput = {
    ...
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    updatedAt?: DateTimeFieldUpdateOperationsInput | Date | string
    films?: FilmActorUpdateManyWithoutActorNestedInput
  }
  ...
  export type ActorUncheckedUpdateInput = {
    ...
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    updatedAt?: DateTimeFieldUpdateOperationsInput | Date | string
    films?: FilmActorUncheckedUpdateManyWithoutActorNestedInput
  }
  ...
  export type FilmCreateInput = {
    ...
    name: string
    imageUrl?: string | null
    actors?: FilmActorCreateNestedManyWithoutFilmInput
  }
  ...
  export type FilmUncheckedCreateInput = {
    ...
    name: string
    imageUrl?: string | null
    actors?: FilmActorUncheckedCreateNestedManyWithoutFilmInput
  }
  ...
  export type FilmUpdateInput = {
    ...
    actors?: FilmActorUpdateManyWithoutFilmNestedInput
  }
  ...
  export type FilmUncheckedUpdateInput = {
    ...
    name?: StringFieldUpdateOperationsInput | string
    imageUrl?: NullableStringFieldUpdateOperationsInput | string | null
    actors?: FilmActorUncheckedUpdateManyWithoutFilmNestedInput
  }
  ...
  export type FilmActorCreateInput = {
    id?: string
    film: FilmCreateNestedOneWithoutActorsInput
    actor: ActorCreateNestedOneWithoutFilmsInput
  }
  ...
  export type FilmActorUpdateInput = {
    id?: StringFieldUpdateOperationsInput | string
    film?: FilmUpdateOneRequiredWithoutActorsNestedInput
    actor?: ActorUpdateOneRequiredWithoutFilmsNestedInput
  }
  ...
  export type FilmCreateNestedOneWithoutActorsInput = {
    create?: XOR<FilmCreateWithoutActorsInput, FilmUncheckedCreateWithoutActorsInput>
    connectOrCreate?: FilmCreateOrConnectWithoutActorsInput
    connect?: FilmWhereUniqueInput
  }

  export type ActorCreateNestedOneWithoutFilmsInput = {
    create?: XOR<ActorCreateWithoutFilmsInput, ActorUncheckedCreateWithoutFilmsInput>
    connectOrCreate?: ActorCreateOrConnectWithoutFilmsInput
  ...
  export type FilmUpdateOneRequiredWithoutActorsNestedInput = {
    create?: XOR<FilmCreateWithoutActorsInput, FilmUncheckedCreateWithoutActorsInput>
    connectOrCreate?: FilmCreateOrConnectWithoutActorsInput
    upsert?: FilmUpsertWithoutActorsInput
    connect?: FilmWhereUniqueInput
    update?: XOR<XOR<FilmUpdateToOneWithWhereWithoutActorsInput, FilmUpdateWithoutActorsInput>, FilmUncheckedUpdateWithoutActorsInput>
  }

  export type ActorUpdateOneRequiredWithoutFilmsNestedInput = {
    create?: XOR<ActorCreateWithoutFilmsInput, ActorUncheckedCreateWithoutFilmsInput>
    connectOrCreate?: ActorCreateOrConnectWithoutFilmsInput
    upsert?: ActorUpsertWithoutFilmsInput
    connect?: ActorWhereUniqueInput
    update?: XOR<XOR<ActorUpdateToOneWithWhereWithoutFilmsInput, ActorUpdateWithoutFilmsInput>, ActorUncheckedUpdateWithoutFilmsInput>
  }
  ...
  export type FilmUpsertWithoutActorsInput = {
    update: XOR<FilmUpdateWithoutActorsInput, FilmUncheckedUpdateWithoutActorsInput>
    create: XOR<FilmCreateWithoutActorsInput, FilmUncheckedCreateWithoutActorsInput>
    where?: FilmWhereInput
  }
  ...
  export type FilmUpdateToOneWithWhereWithoutActorsInput = {
    where?: FilmWhereInput
    data: XOR<FilmUpdateWithoutActorsInput, FilmUncheckedUpdateWithoutActorsInput>
  }
  ...
  export type ActorUpsertWithoutFilmsInput = {
    update: XOR<ActorUpdateWithoutFilmsInput, ActorUncheckedUpdateWithoutFilmsInput>
    create: XOR<ActorCreateWithoutFilmsInput, ActorUncheckedCreateWithoutFilmsInput>
    where?: ActorWhereInput
  }

  export type ActorUpdateToOneWithWhereWithoutFilmsInput = {
    where?: ActorWhereInput
